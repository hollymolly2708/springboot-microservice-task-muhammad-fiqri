...
public class BookController {
    ...
    public WebResponse<String> addBook(@Valid @ModelAttribute AddBookRequest request) {
    ...
    public WebResponse<BookResponse> updateBookById(@PathVariable("id") Long id, @Valid @ModelAttribute UpdateBookRequest request) {
    ...
    public WebResponse<BookResponse> patchBookById(@PathVariable("id") Long id, @Valid @ModelAttribute PatchBookRequest request) {
